...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    An understanding of address aliasing is necessary in order to achieve optimal performance, and we outline how application developers can utilize this knowledge.
    \end{abstract}
    \bigskip
