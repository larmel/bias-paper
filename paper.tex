...
\begin{table*}[t]
  ...
  \pgfplotstabletypeset[
    ...
    col sep=comma,
    string type,
    columns={Allocation, 64, 1024, 65536, 1048576, 4194304},
    column type=r,
    ...
    every head row/.style={
      output empty row,
      before row={\toprule
         & 64 B & 1,024 B & 65,536 B & 1,048,576 B & 4,194,304 B \\
        },
      after row=\midrule,
    },
...
In our convolution kernel example, there are several ways to limit the extent of aliasing.
...
\end{lstlisting}
With this updated function prototype, most of the address aliasing events are gone for the default alignment.
