...
The performance impact of unfavorable memory layouts can be significant, causing up to a $2x$ performance degradation in already optimized code.
...
Dynamically allocated data is controlled by heap allocators, which we find is another source of bias.
