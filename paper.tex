...
False dependencies will limit the amount of speculation, making the CPU incorrectly discard executed instructions.
...
It is worth noticing that most cache related metrics do \emph{not} stand out in this experiment.
...
The L1 hit rate remains stable across all offsets, and only a negligible number of memory accesses actually miss L1.
