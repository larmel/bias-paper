...
int main() {
  ...
  \end{lstlisting}
  \caption{\label{fig:microkernel}Microkernel first presented by \citeN{Mytkowicz:2009:WrongData}, showing bias to environment size.}
\end{figure}
...
To illustrate how address aliasing can cause bias, we revisit the example first presented in ``Producing Wrong Data Without Doing Anything Obviously Wrong!'' by \citeN{Mytkowicz:2009:WrongData}, a small C program reproduced here in Figure~\ref{fig:microkernel}.
