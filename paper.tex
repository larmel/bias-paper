...
This can be achieved by reserving 8 extra bytes to offset i, j into the 0x8, 0xc slots. 
...
\subsection{Avoid Aliasing -- A Proof of Concept}
...
\section{Aliasing in BLAS}
Another test case, show numbers for ATLAS OR default blas in Ubuntu, or maybe both. Copy thesis more or less I guess.
