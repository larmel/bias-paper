...
Our setup consists of an Intel\textregistered{} Core\texttrademark{} i7-4770K CPU @ 3.50 GHz, running 64-bit Ubuntu 13.10.
Because bias can be hardware dependent, and to keep the scope of this work manageable, we choose to focus only on this processor and the Intel ``Haswell'' microarchitecture specifically.
...
All benchmarks are done on a machine under minimal load, and \emph{Frequency scaling} is disabled to keep the processor's clock speed fixed.
