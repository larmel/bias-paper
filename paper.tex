...
The number of times this happens can be counted by the following event:\vspace{-2mm}
\begin{description}
...
Older architectures such as Core do not have this particular event listed, but 4K aliasing is covered by a more general event:\vspace{-2mm}
\begin{description}
...
\begin{description}
  ...
  \item[Level 3] Matrix-matrix operations, including the widely applied gemm routine for general matrix multiplication.
\end{description}
