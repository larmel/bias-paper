...
These counters are obviously not indicative of any causal relationship, and are ommitted.
...
A small amount of assembly code was added to calculate the addresses of \texttt{g} and \texttt{inc}, outputing to stdout direcly using the \texttt{syscall} instruction.
