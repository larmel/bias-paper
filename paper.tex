...
Previous work has studied parameters such as the size of Unix environment variables and program link order \cite{Mytkowicz:2008:OE&MB}. 
...
To measure statistics with n bytes added to the environment, a dummy variable is set to \(0^{n}\) (repeated zero characters n times).\footnote{Because perf-stat adds a few variables, the environment will never be completely empty.}
