...
What if changing your user name affected the execution time of your programs?
...
\begin{itemize}
  ...
  \item Effects can invalidate perceived speedup~\cite{Mytkowicz:2008:OE&MB}.
\end{itemize}
...
\begin{itemize}
  ...
  \item Opportunities to optimize for aliasing.
